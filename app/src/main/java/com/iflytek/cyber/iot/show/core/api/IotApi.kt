...
interface IotApi {
    ...
    @GET("https://${BuildConfig.PREFIX}home.iflyos.cn/web/smart_home/user/iots")
    fun getIots(): Call<ArrayList<Brand>>

    @POST("v2/iot/user/device")
    fun getDeviceDetail(@Body body: RequestBody): Call<Device>

    @GET("https://${BuildConfig.PREFIX}home.iflyos.cn/web/smart_home/iots/{iot_id}/auth_url")
    ...
    @PUT("https://${BuildConfig.PREFIX}home.iflyos.cn/web/smart_home/user/sync_all_devices")
    fun syncDevice(): Call<Message>

    @DELETE("https://${BuildConfig.PREFIX}home.iflyos.cn/web/smart_home/iot/brands/{iot_id}/token_infos")
