...
public class ShadowFrameLayout extends FrameLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        int xPadding = (int) mShadowRadius;
        int yPadding = (int) mShadowRadius;
        //setPadding(xPadding, getPaddingTop(), xPadding, getPaddingBottom());
    }
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            mCornerRadius = attr.getDimension(R.styleable.ShadowFrameLayout_sl_cornerRadius, getResources().getDimension(R.dimen.dp_4));
            mShadowRadius = attr.getDimension(R.styleable.ShadowFrameLayout_sl_shadowRadius, getResources().getDimension(R.dimen.dp_4));
            mDx = attr.getDimension(R.styleable.ShadowFrameLayout_sl_dx, 0);
            mDy = attr.getDimension(R.styleable.ShadowFrameLayout_sl_dy, 0);
            mShadowColor = attr.getColor(R.styleable.ShadowFrameLayout_sl_shadowColor, getResources().getColor(R.color.default_shadow_color));
        } finally {
            attr.recycle();
        }
    }
    ...
    private Bitmap createShadowBitmap(int shadowWidth, int shadowHeight, float cornerRadius, float shadowRadius,
        ...
        RectF shadowRect = new RectF(
                ...
                shadowRadius,
                shadowWidth - shadowRadius - shadowRadius,
