...
open class BaseFragment : Fragment(), ISupportFragment {
    ...
    var launcher: EvsLauncherActivity? = null

    private val mDelegate = SupportFragmentDelegate(this)
    private lateinit var mActivity: ISupportActivity

    override fun onAttach(context: Context) {
        super.onAttach(context)
        if (context is EvsLauncherActivity) {
            launcher = context
        }
        mDelegate.onAttach(activity)
        mActivity = mDelegate.activity as ISupportActivity
    }
    ...
    fun getSupportActivity() = mActivity
}