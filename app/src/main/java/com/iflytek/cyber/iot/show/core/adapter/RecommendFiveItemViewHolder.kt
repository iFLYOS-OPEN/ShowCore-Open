...
class RecommendFiveItemViewHolder : ItemViewBinder<DeskRecommend, RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val holder =
            ItemViewHolder(inflater.inflate(R.layout.item_recommend_five_item, parent, false))
    ...
    private class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val childList = arrayOf(
            ItemGroup(itemView, R.id.iv_image_big, R.id.tv_title_big, R.id.item_clickable_big),
