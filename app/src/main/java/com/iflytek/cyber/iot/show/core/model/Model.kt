...
data class Song(var metadata: Metadata,
                var provider: Provider,
                var stream: Stream)

data class Metadata(var title: String?, var subtitle: String?,
                    var source: String?, var art: Art?)

data class Art(var contentDescription: String,
               var sources: ArrayList<Source>?)

data class Source(var url: String)

data class Stream(var offsetInMilliseconds: Long,
                  var token: String,
                  var type: String,
                  var url: String)

data class MusicBody(@SerializedName("media_id") var mediaId: Int? = null,
                     @SerializedName("audio_id") val audioId: String?,
                     val stream: Stream?)

@Parcelize
data class SkillSection(val id: String,
...
data class SkillDetail(@SerializedName("account_link_url") val accountLink: String?,
...
data class Video(@SerializedName("resource_id") val resourceId: String,
                 val offset: Long,
                 val behavior: String,
                 val url: String,
                 val control: String)
...
data class Alert(val id: String,
                 ...
                 @SerializedName("repeat_date") val repeatDate: String) : Parcelable {
...
data class Group(val name: String,
                 ...
                 val abbr: String?,
                 val items: ArrayList<GroupItem>?, val descriptions: ArrayList<String>) : Parcelable
...
data class PlayList(@SerializedName("list_loop") val listLoop: Boolean?,
