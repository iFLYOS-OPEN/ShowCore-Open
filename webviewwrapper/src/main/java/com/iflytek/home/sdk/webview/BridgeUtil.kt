...
internal object BridgeUtil {
    internal val YY_OVERRIDE_SCHEMA = "yy://"
    internal val YY_RETURN_DATA = YY_OVERRIDE_SCHEMA + "return/"//格式为   yy://return/{function}/returncontent
    internal val YY_FETCH_QUEUE = YY_RETURN_DATA + "_fetchQueue/"
    internal val EMPTY_STR = ""
    internal val UNDERLINE_STR = "_"
    internal val SPLIT_MARK = "/"

    internal val CALLBACK_ID_FORMAT = "JAVA_CB_%s"
    internal val JS_HANDLE_MESSAGE_FROM_JAVA = "javascript:WebViewJavascriptBridge._handleMessageFromNative('%s');"
