...
public class Indicator {
    ...
    public Indicator(Context context,
        ...
        this.mIndicatorTopViewType = indicatorTopViewType;
    ...
    private void initIndicator() {
        if (mIndicatorType == IndicatorType.CUSTOM) {
            ...
            if (mIndicatorType == IndicatorType.CIRCULAR_BUBBLE) {
                ...
                if (mIndicatorTopViewType == IndicatorTopViewType.DEFAULT) {
                ...
                } else if (mIndicatorTopViewType == IndicatorTopViewType.CUSTOM) {
                    mIndicatorView = View.inflate(mContext, R.layout.top_view, null);
                    mTopContentView = mIndicatorView.findViewById(R.id.top_content);
                    if (mIndicatorCustomTopContentView != null) {
                        setContentView(mIndicatorCustomTopContentView);
                    }
                }
            }
        }
    ...
    void update(float touchX) {
        ...
        if (mIndicatorPopW != null) {
          ...
          /*  mIndicatorPopW.update(mSeekBar, (int) (touchX - mIndicatorPopW.getContentView().getMeasuredWidth() / 2),
            ...
            mIndicatorPopW.update(mSeekBar, (int) (touchX - mIndicatorPopW.getContentView().getMeasuredWidth() / 2),
                    -(mSeekBar.getMeasuredHeight() + mIndicatorPopW.getContentView().getMeasuredHeight() + mSeekBar.getPaddingTop() * 2 /*- mSeekBar.getTextHeight() */ + mGap), -1, -1);
            adjustArrow(touchX);
        }
    }
    ...
    void show(float touchX) {
        ...
        if (mIndicatorPopW != null) {
           ...
           /* mIndicatorPopW.showAsDropDown(mSeekBar, (int) (touchX - mIndicatorPopW.getContentView().getMeasuredWidth() / 2f),
            ...
            mIndicatorPopW.showAsDropDown(mSeekBar, (int) (touchX - mIndicatorPopW.getContentView().getMeasuredWidth() / 2f),
                    -(mSeekBar.getMeasuredHeight() + mIndicatorPopW.getContentView().getMeasuredHeight() + mSeekBar.getPaddingTop() * 2 /*- mSeekBar.getTextHeight()*/ + mGap));
            adjustArrow(touchX);
        }
    }
    ...
    public void addTopContentView(@NonNull View topContentView) {
